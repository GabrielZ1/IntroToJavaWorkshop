...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog("Enter a type of liqiuid");
		...
		JOptionPane.showMessageDialog(null,
				"Piranhas are more " + adjective + "during the day, so cross the river atnight. Piranhas are attracted to fresh " + liquid
